        ...
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                <div className='flex items-center gap-2'>
                    ...
                    <input type="text" name="search" id='searchTerm' placeholder="Search..." className='border rounded-full p-3 w-full' value={sidebardata.searchTerm} onChange={handleChange}/>
                </div>
                ...
                <button className='bg-[#213555] text-white p-3 rounded-lg hover:opacity-90 uppercase'>Search</button>
            </form>
        </div>
        <div className='flex-1'>
            <h1 className='text-3xl font-semibold border-b p-3 mt-5 text-[#384959] '>Listing results:</h1>
            <div className='p-7 flex flex-wrap gap-4'>
                ...
                {showMore && (
                    <button  onClick={onShowMoreClick} className='p-7 text-green-900 hover:underline text-center w-full'>Load more</button>
                )} 
            </div>
        </div>

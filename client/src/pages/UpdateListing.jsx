...
function UpdateListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-3xl font-semibold text-center my-7 text-[#384959] '>Update a Listing</h1>
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    ...
                    <button onClick={handleImageSubmit} disabled={uploading} type='button' className='p-3 text-green-700 border border-green-700 rounded uppercase hover:bg-green-700 hover:text-white transition-all disabled:opacity-80'>
